...
async def _auth(c: UtubeBot, m: Message) -> None:
    ...
    try:
        ...
        # ✅ RECREATE FLOW (CRITICAL FIX)
        flow = InstalledAppFlow.from_client_config(
            auth.client_config,
            scopes=auth.OAUTH_SCOPE
        )
        ...
        await msg2.reply_text(
            "This is your authorisation data! Save this for later use. "
            "Reply /save_auth_data to the authorisation data to re authorise later.",
            True,
        )
